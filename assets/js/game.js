...
var randomNumber = function(min, max) {
  ...
  var fightOrSkip = function() {
    // ask player if the'd like to fight or skip using function
  ...
  var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
      'Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter 1 to REFILL, 2 to UPGRADE, or 3 to LEAVE shop.'
    );
    
    // convert string prompt response to int
